...
const styles = StyleSheet.create({
  ...
  monthSelector: {
    ...
    marginTop: 8, padding: 6, backgroundColor: '#fff', borderRadius: 14, elevation: 2,
    shadowColor: colors.dark, shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.05, shadowRadius: 6,
  },
  monthButton: { width: 28, height: 28, borderRadius: 8, backgroundColor: colors.gray[100], alignItems: 'center', justifyContent: 'center' },
  monthButtonText: { color: colors.primary, fontSize: 20, fontWeight: '500', lineHeight: 25 },
  monthLabel: { color: colors.gray[500], fontSize: 9, fontWeight: '800', letterSpacing: 0.8, textAlign: 'center' },
  monthTitle: { color: colors.dark, fontSize: 14, fontWeight: '800', marginTop: 1, textAlign: 'center', textTransform: 'capitalize' },
